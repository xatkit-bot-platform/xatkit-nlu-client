...
import com.xatkit.core.recognition.dialogflow.stubs.DialogFlowTestingStateContextFactory;
...
public class DialogFlowIntentRecognitionProviderTest extends IntentRecognitionProviderTest<DialogFlowIntentRecognitionProvider> {
    ...
    public void setUp() throws Exception {
        super.setUp();
        this.contextFactory = new DialogFlowTestingStateContextFactory();
    }
    ...
    private static Configuration buildConfiguration(String projectId, String languageCode) {
        ...
        configuration.addProperty(IntentRecognitionProviderFactory.INTENT_PROVIDER_KEY, DialogFlowConfiguration.DIALOGLFOW_INTENT_PROVIDER);
